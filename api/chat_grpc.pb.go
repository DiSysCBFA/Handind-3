...
type ChittyChatClient interface {
	...
	Join(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error)
}
...
func (c *chittyChatClient) Join(ctx context.Context, in *Empty, opts ...grpc.CallOption) (grpc.ServerStreamingClient[Message], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ChittyChat_JoinClient = grpc.ServerStreamingClient[Message]
...
type ChittyChatServer interface {
	...
	Join(*Empty, grpc.ServerStreamingServer[Message]) error
...
func (UnimplementedChittyChatServer) Join(*Empty, grpc.ServerStreamingServer[Message]) error {
...
func _ChittyChat_Join_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(ChittyChatServer).Join(m, &grpc.GenericServerStream[Empty, Message]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ChittyChat_JoinServer = grpc.ServerStreamingServer[Message]
